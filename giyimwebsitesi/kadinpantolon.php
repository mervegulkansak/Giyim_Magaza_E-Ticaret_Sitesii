...
<body>
  ...
  <!--KADIN CİNSİYETİNDEKİ ALT GİYİM(PANTOLON) KATEGORSİNE AİT ÜRÜN VERİLERİNİ ÇEKME-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '1' AND kategoriID = '4' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<?php 
      ...
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KADIN PANTOLON</div>
      </div>

...
<body>
  ...
  <!--ERKEK CİNSİYETİNDEKİ DIŞ GİYİM(CEKET&KABAN) KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '2' yani ERKEK ve kategoriID '1' yani DIŞ GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '2' and kategoriID = '1' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK CEKET&KABAN</div>
      </div>

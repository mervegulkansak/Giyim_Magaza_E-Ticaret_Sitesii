...
<head>
  ...
  <title>ERKEK ÇOCUK ALT GİYİM</title>
  <meta charset="utf-8">
...
<body>
  ...
  <?php include ("yanmenu.php") ?>
    ...
    <!--ERKEK ÇOCUK CİNSİYETİNDEKİ ALT GİYİM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '3' yani ERKEK ÇOCUK ve kategoriID '4' yani ALT GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '3' AND kategoriID = '4'", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK ÇOCUK ALT GİYİM</div>
      </div>

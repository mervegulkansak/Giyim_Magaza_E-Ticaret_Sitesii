...
<?php include ("yanmenu.php") ?>
  ...
  <!--KIZ BEBEK CİNSİYETİNDEKİ ZIBIN&TAKIM&TULUM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '6' yani KIZ BEBEK ve kategoriID '9' yani ZIBIN&TAKIM&TULUM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '6' AND kategoriID = '9' ", PDO::FETCH_OBJ)->fetchAll()   ?>
  ...
  <?php include("navbar.php"); ?>
   ...
   <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ZIBIN&TAKIM&TULUM</div>
      </div>

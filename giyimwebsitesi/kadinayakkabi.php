...
<body>
 ...
 <?php include ("yanmenu.php") ?>
       <?php 
      $beden=$db->prepare("SELECT * FROM tblbeden where bedenID BETWEEN '18' AND '21'");
      $beden->execute();
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
       
  <!--KADIN CİNSİYETİNDEKİ AYAKKABI KATEGORSİNE AİT ÜRÜN VERİLERİNİ ÇEKME-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '1' AND kategoriID = '7' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php include("navbar.php"); ?>
      ...
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KADIN AYAKKABI</div>
      </div>

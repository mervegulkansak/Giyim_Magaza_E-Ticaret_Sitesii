...
<?php include ("yanmenu.php") ?>
  <!--ERKEK KATEGORSİNE AİT ÜRÜN VERİLERİNİ ÇEKME-->
  <!-- cinsiyetID'si '2' olan yani "Erkek" olan ürünleri listeler. -->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '2'", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK</div>
      </div>

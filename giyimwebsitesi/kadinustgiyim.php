...
<?php include ("yanmenu.php") ?>
  ...
  <!--KADIN CİNSİYETİNDEKİ ÜST GİYİM KATEGORSİNE AİT ÜRÜN VERİLERİNİ ÇEKME-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '1' AND kategoriID = '3' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KADIN ÜST GİYİM</div>
      </div>

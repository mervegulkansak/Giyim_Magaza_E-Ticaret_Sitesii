...
<head>
  ...
  <title>ERKEK ÇOCUK DIŞ GİYİM</title>
  <meta charset="utf-8">
...
<?php include ("yanmenu.php") ?>
   ...
   <!--ERKEK ÇOCUK CİNSİYETİNDEKİ DIŞ GİYİM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '3' yani ERKEK ÇOCUK ve kategoriID '1' yani DIŞ GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '3' AND kategoriID = '1' ", PDO::FETCH_OBJ)->fetchAll()   ?>
  ...
  <?php include("navbar.php"); ?>
   ...
   <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK ÇOCUK DIS GİYİM</div>
      </div>

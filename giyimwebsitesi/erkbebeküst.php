...
<?php include ("yanmenu.php") ?>
   ...
   <!--ERKEK BEBEK CİNSİYETİNDEKİ ÜST GİYİM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '5' yani ERKEK BEBEK ve kategoriID '3' yani ÜST GİYİM olan ürünleri listeler-->
  <?php $urunler = $db->query("SELECT * from tblurunler Where cinsiyetID = '5' AND kategoriID = '3' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK BEBEK ÜST GİYİM</div>
      </div>

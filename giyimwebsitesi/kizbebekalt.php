...
<head>
  ...
  <title>KIZ BEBEK ALT GİYİM</title>
  <meta charset="utf-8">
...
<?php include ("yanmenu.php") ?>
    ...
    <!--KIZ BEBEK CİNSİYETİNDEKİ ALT GİYİM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '6' yani KIZ BEBEK ve kategoriID '4' yani ALT GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '6' AND kategoriID = '4' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<?php 
      ...
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KIZ BEBEK ALT GİYİM</div>
      </div>

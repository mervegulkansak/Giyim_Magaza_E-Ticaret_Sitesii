...
<head>
  ...
  <title>BLAZER&TAKIM ELBİSE</title>
  <meta charset="utf-8">
...
<?php include ("yanmenu.php") ?>
  ...
  <!--ERKEK CİNSİYETİNDEKİ BLAZER&TAKIM ELBİSE KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '2' yani ERKEK ve kategoriID '8' yani BLAZER&TAKIM ELBİSE olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '2' AND kategoriID = '8' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>BLAZER&TAKIM ELBİSE</div>
      </div>

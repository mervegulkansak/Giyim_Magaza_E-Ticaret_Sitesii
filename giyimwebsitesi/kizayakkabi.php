...
<head>
  ...
  <title>KIZ ÇOCUK AYAKKABI</title>
  <meta charset="utf-8">
...
<?php include ("yanmenu.php") ?>
  ...
  <!--KIZ ÇOCUK CİNSİYETİNDEKİ AYAKKABI KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '4' yani KIZ ÇOCUK ve kategoriID '7' yani AYAKKABI olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '4' AND kategoriID = '7' ", PDO::FETCH_OBJ)->fetchAll()   ?>
  ...
  <?php include("navbar.php"); ?>
   ...
   <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KIZ ÇOCUK AYAKKABI</div>
      </div>

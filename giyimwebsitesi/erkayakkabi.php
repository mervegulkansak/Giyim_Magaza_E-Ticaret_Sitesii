...
<head>
  ...
  <title>ERKEK ÇOCUK AYAKKABI</title>
  <meta charset="utf-8">
...
<body>
  ...
  <?php include ("yanmenu.php") ?>
   ...
   <!--ERKEK ÇOCUK CİNSİYETİNDEKİ AYAKKABI KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '3' yani ERKEK ÇOCUK ve kategoriID '7' yani AYAKKABI olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '5' AND kategoriID = '7' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK ÇOCUK AYAKKABI</div>
      </div>

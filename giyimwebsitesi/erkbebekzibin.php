...
<?php include ("yanmenu.php") ?>
   ...
   <!--ERKEK BEBEK CİNSİYETİNDEKİ ZIBIN&TULUM&TAKIM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '5' yani ERKEK BEBEK ve kategoriID '9' yani ZIBIN&TULUM&TAKIM olan ürünleri listeler-->
  <?php $urunler = $db->query("SELECT * from tblurunler Where cinsiyetID = '5' and kategoriID = '9' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
 ...
 <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ZIBIN&TULUM&TAKIM</div>
      </div>

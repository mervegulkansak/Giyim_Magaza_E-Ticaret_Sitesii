...
<?php include ("yanmenu.php") ?>
  ...
  <!--ERKEK CİNSİYETİNDEKİ PİJAMA KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '2' yani ERKEK ve kategoriID '6' yani PİJAMA olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '2' AND kategoriID = '6' ", PDO::FETCH_OBJ)->fetchAll()   ?>
  ...
  <?php include("navbar.php"); ?>
   ...
   <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK PİJAMA</div>
      </div>

...
<head>
  ...
  <title>ERKEK BEBEK AYAKKABI</title>
  <meta charset="utf-8">
...
<?php include ("yanmenu.php") ?>
    ...
    <!--ERKEK BEBEK CİNSİYETİNDEKİ AYAKKABI KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '5' yani ERKEK BEBEK ve kategoriID '7' yani AYAKKABI olan ürünleri listeler-->
  <?php $urunler = $db->query("SELECT * from tblurunler Where cinsiyetID = '5' AND kategoriID = '7' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK BEBEK AYAKKABI</div>
      </div>

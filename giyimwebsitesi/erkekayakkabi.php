...
<?php session_start(); ?>
  ...
  <!--ERKEK CİNSİYETİNDEKİ AYAKKABI KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '2' yani ERKEK ve kategoriID '7' yani AYAKKABI olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '2' AND kategoriID = '7' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
 ...
 <?php 
      $beden=$db->prepare("SELECT * FROM tblbeden where bedenID BETWEEN '18' AND '24'");
      $beden->execute();
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>ERKEK AYAKKABI</div>
      </div>

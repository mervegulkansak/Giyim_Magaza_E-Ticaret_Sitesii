...
<head>
  ...
  <title>KIZ ÇOCUK ALT GİYİM</title>
  <meta charset="utf-8">
...
<body>
  ...
  <!--KIZ ÇOCUK CİNSİYETİNDEKİ ALT GİYİM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '4' yani KIZ ÇOCUK ve kategoriID '4' yani ALT GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '4' and kategoriID = '4' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KIZ ÇOCUK ALT GİYİM</div>
      </div>

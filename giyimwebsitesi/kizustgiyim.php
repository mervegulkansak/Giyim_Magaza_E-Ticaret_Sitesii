...
<?php include ("yanmenu.php") ?>
  ...
  <!--KIZ ÇOCUK CİNSİYETİNDEKİ ÜST GİYİM KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '4' yani KIZ ÇOCUK ve kategoriID '3' yani ÜST GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '4' AND kategoriID = '3' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KIZ ÇOCUK ÜST GİYİM</div>
      </div>

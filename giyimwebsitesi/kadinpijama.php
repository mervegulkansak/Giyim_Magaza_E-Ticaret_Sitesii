...
<?php include ("yanmenu.php") ?>
  ...
  <!--KADIN CİNSİYETİNDEKİ PİJAMA KATEGORSİNE AİT ÜRÜN VERİLERİNİ ÇEKME-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '1' AND kategoriID = '6' ", PDO::FETCH_OBJ)->fetchAll()   ?>
  ...
  <?php include("navbar.php"); ?>
    ...
    <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>KADIN PİJAMA</div>
      </div>

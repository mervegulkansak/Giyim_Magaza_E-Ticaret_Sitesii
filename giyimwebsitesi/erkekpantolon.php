...
<?php include ("yanmenu.php") ?>
  ...
  <!--ERKEK CİNSİYETİNDEKİ ALT GİYİM(PANTOLON) KATEGORİSİNE AİT ÜRÜN VERİLERİNİ LİSTELER-->
  <!--cinsiyetID si '2' yani ERKEK ve kategoriID '4' yani ALT GİYİM olan ürünleri listeler-->
  <?php $urun = $db->query("SELECT * from tblurunler Where cinsiyetID = '2' AND kategoriID = '4' ", PDO::FETCH_OBJ)->fetchAll()   ?>
...
<div id="main" class="container">
  ...
  <?php 
      ...
      $satirlar = $beden->fetchALL(PDO::FETCH_ASSOC);
       ?>
      <div class="row">
      <div  class="col-md-4" id="yazi"><i class="fa fa-chevron-right"></i>PANTOLON&SORT</div>
      </div>
